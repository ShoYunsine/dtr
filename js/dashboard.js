document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set the first tab as active by default and show its content
    if (tabs.length > 0) {
